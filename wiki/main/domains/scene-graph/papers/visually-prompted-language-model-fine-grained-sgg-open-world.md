...
source_pages: []
raw_sources:
  - ../../../sources/scene-graph/2023-ICCV-visually-prompted-language-model-fine-grained-sgg-open-world.pdf
  - ../../../sources/scene-graph/2023-ICCV-visually-prompted-language-model-fine-grained-sgg-open-world.txt
paper:
  title: "Visually Prompted Language Model for Fine-Grained Scene Graph Generation in an Open World"
  authors:
    - Qifan Yu
...
- 原始 PDF: `../../../sources/scene-graph/2023-ICCV-visually-prompted-language-model-fine-grained-sgg-open-world.pdf`
- 提取文本: `../../../sources/scene-graph/2023-ICCV-visually-prompted-language-model-fine-grained-sgg-open-world.txt`
