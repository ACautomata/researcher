...
| 字段 | 值 |
|------|-----|
| **标题** | Revisiting Weakly-Supervised Video Scene Graph Generation via Pair Affinity Learning |
| **作者** | Minseok Kang, Minhyeok Lee, Minjung Kim, Jungho Lee, Donghyeong Kim, Sungmin Woo, Inseok Jeon, Sangyoun Lee |
| **机构** | Yonsei University, LG Electronics |
| **发表** | arXiv 2026 |
| **arXiv** | [2603.21559](https://arxiv.org/abs/2603.21559) |
| **DOI** | — |
| **代码** | — |
| **证据等级** | full-paper |
| **原始来源** | [raw/sources/2026-arXiv-Revisiting-Weakly-Supervised-Video-SGG.pdf](/.raw/sources/2026-arXiv-Revisiting-Weakly-Supervised-Video-SGG.pdf) |
| **入库日期** | 2026-06-09 |
