...
> 频率引导的多层次推理视频场景图生成，通过解耦学习和专用分类头提升长尾关系建模

## 元数据

| 字段 | 值 |
|------|-----|
| **标题** | Frequency-Guided Multi-Level Reasoning for Scene Graph Generation in Video |
| **作者** | Chenxing Li, Yiping Duan, Xiaoming Tao (清华大学电子工程系 / 空间网络与通信国家重点实验室 / 北京信息科学与技术国家研究中心 / 新疆大学计算机科学与技术学院) |
| **发表** | arXiv 2026 (ICASSP 2026?) |
| **arXiv** | — |
| **DOI** | — |
| **代码** | [https://github.com/lcx529955/FReMuRe](https://github.com/lcx529955/FReMuRe) |
| **证据等级** | full-paper |
| **原始来源** | [raw/sources/2026-06-09-frequency-guided-multi-level-reasoning-sgg.pdf](/.raw/sources/2026-06-09-frequency-guided-multi-level-reasoning-sgg.pdf) |
| **入库日期** | 2026-06-09 |
