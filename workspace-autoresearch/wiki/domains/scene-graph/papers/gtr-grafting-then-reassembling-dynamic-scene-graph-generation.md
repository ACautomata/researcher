...
source_pages: []
raw_sources:
  - raw/sources/2023-08-gtr-grafting-then-reassembling-dynamic-sgg.txt
  - raw/sources/2023-08-gtr-grafting-then-reassembling-dynamic-sgg.pdf
related_pages: []
paper:
  title: "GTR: A Grafting-Then-Reassembling Framework for Dynamic Scene Graph Generation"
  authors:
...
- **Source**: raw/sources/2023-08-gtr-grafting-then-reassembling-dynamic-sgg.txt（45474字符全文提取）
