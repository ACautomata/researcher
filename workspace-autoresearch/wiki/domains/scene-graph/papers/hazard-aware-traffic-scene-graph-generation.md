...
| **机构** | Australian Center for Robotics (ACFR), The University of Sydney |
| **发表** | arXiv 2026 (arXiv:2603.03584v2, 2026-05-04) |
| **领域** | scene-graph |
| **证据等级** | full-paper |
| **代码** | — |
| **关键词** | Traffic Scene Graph, Hazard Awareness, Knowledge Graph Embedding, Ego-centric Reasoning, Autonomous Driving |
