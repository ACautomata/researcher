...
- **机构**: Karlsruhe Institute of Technology, Shenzhen University, Hunan University
- **arXiv**: [2603.04614](https://arxiv.org/abs/2603.04614)
- **代码**: 未提供
- **领域**: scene-graph
- **证据等级**: full-paper（全文精读，含实验表格和消融）
- **关键词**: 3D Scene Graph, MLLM, RAG, Training-free, ColPali, ColQwen
