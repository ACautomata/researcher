...
- **标题 (EN):** VIZOR: Viewpoint-Invariant Zero-Shot Scene Graph Generation for 3D Scene Reasoning
- **作者:** Vivek Madhavaram, Vartika Sengar, Arkadipta De, Charu Sharma
- **机构:** IIIT Hyderabad (Machine Learning Lab) + Fujitsu Research India
- **论文:** https://arxiv.org/abs/2602.00637
- **项目页:** https://vivekmadhavaram.github.io/vizor/
- **代码:** 未提及
- **领域:** scene-graph
- **关键词:** 3D scene graph, zero-shot, viewpoint-invariant, training-free, open-vocabulary, object grounding
- **证据等级:** full-paper（12页全文阅读）
- **入库日期:** 2026-06-09
