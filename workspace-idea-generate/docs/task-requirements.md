...
- `../../benchmarks/idea-generate/seed-qa.md`: 人工构建的 seed QA。
- `../../benchmarks/idea-generate/benchmark-spec.md`: 完整 benchmark 构建规则和扩充规则。
- `../../benchmarks/idea-generate/self-test-report-template.md`: 自测报告模板。
